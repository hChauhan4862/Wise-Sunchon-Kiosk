...
func newBoard(db *gorm.DB, opts ...gen.DOOption) board {
	...
	_board.Seq = field.NewInt64(tableName, "seq")
	_board.Title = field.NewString(tableName, "title")
	_board.Contents = field.NewString(tableName, "contents")
	_board.HitCnt = field.NewInt64(tableName, "hit_cnt")
	_board.RegDt = field.NewString(tableName, "reg_dt")
...
func (b *board) updateTableName(table string) *board {
	...
	b.Seq = field.NewInt64(table, "seq")
	b.Title = field.NewString(table, "title")
	b.Contents = field.NewString(table, "contents")
	b.HitCnt = field.NewInt64(table, "hit_cnt")
...
func (b *board) fillFieldMap() {
	...
	b.fieldMap["seq"] = b.Seq
	b.fieldMap["title"] = b.Title
	b.fieldMap["contents"] = b.Contents
	b.fieldMap["hit_cnt"] = b.HitCnt

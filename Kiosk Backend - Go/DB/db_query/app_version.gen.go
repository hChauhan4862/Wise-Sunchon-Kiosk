...
func newAppVersion(db *gorm.DB, opts ...gen.DOOption) appVersion {
	...
	_appVersion.AndVersion = field.NewString(tableName, "and_version")
	_appVersion.AndRegDt = field.NewString(tableName, "and_reg_dt")
	_appVersion.IosVersion = field.NewString(tableName, "ios_version")
	_appVersion.IosRegDt = field.NewString(tableName, "ios_reg_dt")
...
type appVersion struct {
	...
	ALL        field.Asterisk
	AndVersion field.String
	AndRegDt   field.String
	IosVersion field.String
	IosRegDt   field.String
...
func (a *appVersion) updateTableName(table string) *appVersion {
	...
	a.AndVersion = field.NewString(table, "and_version")
	a.AndRegDt = field.NewString(table, "and_reg_dt")
	a.IosVersion = field.NewString(table, "ios_version")
	a.IosRegDt = field.NewString(table, "ios_reg_dt")
...
func (a *appVersion) fillFieldMap() {
	...
	a.fieldMap["and_version"] = a.AndVersion
	a.fieldMap["and_reg_dt"] = a.AndRegDt
	a.fieldMap["ios_version"] = a.IosVersion
	a.fieldMap["ios_reg_dt"] = a.IosRegDt
}

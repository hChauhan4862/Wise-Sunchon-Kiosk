...
const TableNameHCV_view_seat_booking = "view_seat_booking"

// HCV_view_seat_booking mapped from table <view_seat_booking>
...
// TableName HCV_view_seat_booking's table name
func (*HCV_view_seat_booking) TableName() string {
	return TableNameHCV_view_seat_booking
}

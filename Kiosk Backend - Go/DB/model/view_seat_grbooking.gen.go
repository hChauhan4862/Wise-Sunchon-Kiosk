...
const TableNameHCV_view_seat_grbooking = "view_seat_grbooking"

// HCV_view_seat_grbooking mapped from table <view_seat_grbooking>
type HCV_view_seat_grbooking struct {
	...
	SCHOOLNO2              *string    `gorm:"column:SCHOOLNO2" json:"SCHOOLNO2"`
}

// TableName HCV_view_seat_grbooking's table name
func (*HCV_view_seat_grbooking) TableName() string {
	return TableNameHCV_view_seat_grbooking
}

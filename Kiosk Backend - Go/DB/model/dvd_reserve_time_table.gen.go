...
const TableNameHCV_DVD_reserve_time_table = "DVD_reserve_time_table"

// HCV_DVD_reserve_time_table mapped from table <DVD_reserve_time_table>
...
// TableName HCV_DVD_reserve_time_table's table name
func (*HCV_DVD_reserve_time_table) TableName() string {
	return TableNameHCV_DVD_reserve_time_table
}
